...
<head>
  ...
  <title>Rural Bank</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/titleicon.png" rel="icon">
  <link href="assets/img/titleicon.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo"><img src="assets/img/icon1.png" alt="" class="img-fluid"> &nbsp Rural Bank</a>
      <!-- <h1 class="logo"><a href="index.html">Rural Bank</a></h1> -->
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Welcome to Rural Bank Internet Banking</h1>
          <h2>Making Banking simple, convenient and secure.</h2>
          <div class="heroBtn">
            <div><a href="user/CreateAccount.php" class="btn-get-started scrollto">Sign Up Now</a></div>
        ...
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="assets/img/Bank1.svg" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Join Us Now</h3>
            <p class="font-italic">You just need to follow 4 steps to start banking with us. Lets introduce to you with account creation steps.</p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Fill Your Basic Detail.</li>
              <li><i class="bi bi-check-circle"></i> Upload Your KYC Document.</li>
              <li><i class="bi bi-check-circle"></i> Validate Your Email Address.</li>
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ">
            <iframe class="mb-4 mb-lg-0" src="<?php echo LOCATION_CORDINATE ?>" frameborder="0" style="border:0; width: 100%; height: 370px;" allowfullscreen></iframe>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <div class="d-flex justify-content-center">
              <img src="assets/img/iconfooter.svg" style="width: 100px; height: 100px;" alt="">
            </div>
